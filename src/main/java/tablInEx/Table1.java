...
public class Table1 {
	...
	/** The cells. Cell matrix of the table */
        ...
        public Cell[][] Row_cells;
	public Cell[][] Row_original_cells;
	 ...
	 */
	public Table1(String Title, String Caption, String Footer)
	{
		table_title = Title;
	 ...
	 * @param Rows the rows
	 */
	public Table1(String Title, String Caption, String Footer,  int Columns,int Rows)
	{
		table_title = Title;
		table_caption = Caption;
		table_footer = Footer;
